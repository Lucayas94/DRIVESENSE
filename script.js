 ...
 * ============================================================
 * Équipe : Ulrich · Rouchy · Arioty · Abdoul
 ...
 */
const CONFIG = {
  API_BASE_URL: "https://votre-api.drivesense.com/api", // 🔧 À adapter
 ...
 * 
 * → Arioty : cette fonction est le cœur du module. Ne pas la renommer.
 */
 ...
 * ]
 * 
 * → Abdoul : le endpoint "/deliveries/today" est à créer côté PostgreSQL/Node.
